...
ggmap(ph_map) +
  geom_sf(data = phl_dist, inherit.aes = FALSE, fill=NA, color="blue") +
  geom_sf(data = phl_taxdel, inherit.aes = FALSE, aes(fill = num_years_)) + 
  ...
  xlab("") + 
  ylab("") + 
  ggtitle("District 7 has most Serious Property Tax Delinquencies", 
          subtitle = "(Serious Tax Delinquencies by City Council District)") + 
