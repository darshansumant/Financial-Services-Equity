...
ggmap(ph_map) +
  ...
  xlab("") + 
  ylab("") + 
  ggtitle("Serious tax delinquencies in Center City tend to be more recent", 
          subtitle = "(North & West suburbs have properties with taxes unpaid for 7+ years)") + 
...
## Consumer Complaints on Mortgage Delinquencies in New York City
