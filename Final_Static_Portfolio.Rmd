...
* California has low NPA rates, though New York, New Jersey have high NPA rates
* This indicates very different Delinquency to NPA flow rates across States, which in turn indicate towards disparity across States in Debt Collections focus & Credit Tightening policies
...
* Even neighboring states with similar delinquency & NPA trends vary widely in self reported stress, such as New York & New Jersey (consistently over 40%) compared to Pennsylvania
* In the South, Texas generated moderate proportion of consumer self reporting of financial stress, and this proportion has further reduced in the last 4 years
...
Our analysis so far warrants a deeper dive into the 3 large Northeastern states of New York, New Jersey, and Pennsylvania. These states have similar population densities & comparable consumer profiles. The delinquency levels & trends across these 3 states have also been fairly similar. However, consumer complaints data shows a stark difference in self-reporting of Financial Stress.

* Delinquency rates across counties is fairly comparable, and the trend seems flat
* Philadelphia county does stand out across the last 4 years with the highest mean delinquency rate
...
Approval Rates (proportion of New Home Purchase mortgages approved by a Financial Services firm or a Bank) are usually a strong and early indicator of Credit Tightening strategy adopted by the lenders. A persistent drop in Approval Rates would mean consumers face higher Credit Accessibility issues.

* We don't see any particular decline in Approval Rates within a County
* Counties in the region differ in terms of mean Approval Rate, however most counties have a healthy approval rate between 70%-90%. Though approval rates might be shifting in terms of customer or property profiles, which need to be examined closely
